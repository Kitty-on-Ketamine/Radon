...
public class Button extends ClickableWidget {
    ...
    public static Identifier TEXTURE_NORMAL = Identifier.of("radon", "widget/button");
    public static Identifier TEXTURE_HOVER = Identifier.of("radon", "widget/button_highlighted");
    public static Identifier TEXTURE_DISABLED = Identifier.of("radon", "widget/button_disabled");
